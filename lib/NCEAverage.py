...
class NCEFunction(Function):
    ...
    def forward(self, x, y, memory, idx, params):
        ...
        out = out.div(Z).reshape(batchSize, K+1)
...
class NCEAverageContinued(nn.Module):

    def __init__(self, inputSize, outputSize, lastMemory, K, T=0.07, momentum=0.5, Z=None):
        super(NCEAverageContinued, self).__init__()
        self.nLem = outputSize
        self.unigrams = torch.ones(self.nLem)
        self.multinomial = AliasMethod(self.unigrams)
        self.multinomial.cuda()
